...
# extract/shift/insert sequences. The correct lowering is
# vpmovzxwd + vpslld $16 (2 instructions). bf16 is just f32 with
# the low 16 bits truncated, so reinterpreting as uint16 →
# zero-extending to uint32 → shifting left 16 produces the
# identical IEEE 754 f32 bit pattern.
